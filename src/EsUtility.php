...
class EsUtility
{
     ...
     * @param array|ArrayAccess $response Elasticsearch response
     * @return int Amount of hits inside the Elasticsearch response
     */
    public static function countHits($response): int
    {
     ...
     */
    public static function hits($response): array
    {
     ...
     */
    public static function lastHit($response): ?array
    {
